    ...
    return (
      <div id="claim-evidence-section">
        <Alert style={{ width: "40rem", marginTop: "20px", textAlign: "left" }}>
          <p>
            You are on <b> question {currentQuestion + 1}</b>. This question has{" "}
            <b> {data[currentQuestion].rationales.length} rationales. </b>
          </p>
          <p>
        ...
        <RationaleAnswer
          rationale={
            data[currentQuestion].rationales[currentRationale].rationale_string
          }
          correct_answer={data[currentQuestion].reference_answer}
          predicted_answer={
            data[currentQuestion].rationales[currentRationale].predicted_answer
          }
